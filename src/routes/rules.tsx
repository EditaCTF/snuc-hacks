		...
		<div className="rules-page">
			...
			<main className="rules-content" ref={contentRef}>
				<header className="rules-header">
					...
					<p className="rules-meta">25th &amp; 26th March | AB3, SNU Chennai</p>
					<hr className="rules-divider" />
				</header>

				{/* 1. Overview */}
				<section id="overview" data-section="overview" className="rules-section">
					<h2 className="rules-h2">1. Overview</h2>
					<hr className="rules-divider" />
					<p>
						SNUC Hacks '26 is the first-ever 24-hour+ Hackathon organized by the SNUC
						Coding Club. This event is designed to empower students to solve real-world
						problems with innovative, tech-driven solutions. We encourage creativity,
				...
				<section id="format" data-section="format" className="rules-section">
					...
					<ul className="rules-list">
						<li>
							<strong>Problem Statements Released</strong> at 9:30 AM on 25th March
						</li>
						<li>
							<strong>Team Leaders Meeting</strong> at 10:00 AM for rules clarification
							and Q&amp;A
						</li>
						<li>
							<strong>Evaluation Rounds</strong> at 3:00 PM (Round 1) and 8:00 AM next
							day (Round 2)
						</li>
						<li>
					...
					<ul className="rules-list">
						...
						<li>
							Source code hosted on a <strong>public GitHub repository</strong> with
							regular commits
						</li>
						<li>
				...
				>
					...
					<ol className="rules-list rules-ol">
						<li>
							Students are not allowed to leave the venue (AB3) during night time.
							Movement within AB3 is permitted, but participants must not disturb
							others —{" "}
						...
						<li>
							Participants are free to leave during daytime. All must return by{" "}
							<strong>8:30 PM on 25th March</strong>. Inform a volunteer if delayed —{" "}
							<strong className="rules-warn">
								participants who fail to return will be disqualified.
							</strong>
						</li>
						<li>
							At least 1–2 members must be present at their hall at all times —{" "}
							<strong className="rules-warn">
						...
						<li>
							Participants must carry their <strong>ID cards</strong> at all times —{" "}
							<strong className="rules-warn">
						...
						<li>
							...
							<strong className="rules-warn">
								teams found responsible for any damage will be held accountable.
							</strong>
						</li>
						<li>
					...
					<ol className="rules-list rules-ol" start={7}>
						<li>
						...
						<li>
							...
							<strong className="rules-warn">
								violation will result in disqualification of all teams involved.
							</strong>
						</li>
						<li>
							Teams must create a <strong>public GitHub repository</strong> and commit
							regularly throughout the event.
						</li>
						<li>
							Teams must push their latest commits before every evaluation round —{" "}
							<strong className="rules-warn">
					...
					<ol className="rules-list rules-ol" start={12}>
						<li>
					...
					<ol className="rules-list rules-ol" start={15}>
						<li>
							Respectful behaviour towards all participants, mentors, and organizers at
							all times —{" "}
							<strong className="rules-warn">
								any form of misconduct will result in immediate removal from the
								event.
							</strong>
						</li>
					</ol>
					...
					<ol className="rules-list rules-ol" start={16}>
						...
						<li>
							Participants will be provided with refreshments during the event — no
							meals such as lunch or dinner will be served.
						</li>
						<li>
							Participants are advised to bring toothbrush, paste or other hygiene
							tools they might require and food.
						</li>
					</ol>
				</section>
				...
				<section id="judging" data-section="judging" className="rules-section">
					...
					<ul className="rules-list">
						<li>
							<strong>Impact &amp; Usefulness</strong> — How effectively does the
							project address the problem statement?
						</li>
						<li>
							<strong>Innovation &amp; Creativity</strong> — Does the solution bring
							fresh ideas or novel approaches?
						</li>
						<li>
							<strong>Technical Implementation</strong> — Quality, scalability, and
							robustness of the code and overall architecture.
						</li>
						<li>
							<strong>Presentation</strong> — Clarity and persuasiveness of the demo
							and project documentation.
						</li>
						<li>
							<strong>Learning</strong> — How much participants have learnt during the
				...
				<section id="ip" data-section="ip" className="rules-section">
					...
					<ul className="rules-list">
						...
						<li>
							By participating, you grant the organizers permission to showcase your
							project in event materials, social media, and websites.
						</li>
					</ul>
				</section>
				...
				<section id="prizes" data-section="prizes" className="rules-section">
					...
					<ul className="rules-list">
						<li>
							<strong>Prize Pool: ₹50,000 INR</strong>
						</li>
					...
					<div className="rules-faq-list">
						{[
							...
							},
							{
								...
								a: "The hack runs from 9:30 AM on 25th March to 8:00 AM on 26th March (24 hours), followed by evaluation rounds and finals till approximately 2:00 PM on 26th March.",
							},
							{
